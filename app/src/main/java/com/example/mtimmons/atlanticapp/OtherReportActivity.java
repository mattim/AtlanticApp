...
public class OtherReportActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_other_report, null, false);
        ...
        String url = "https://remote.atlanticbcs.com/reports/";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_other_report, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.edit_login) {
            Intent i = new Intent(OtherReportActivity.this, SignInActivity.class);
            startActivity(i);
            return true;
        }
